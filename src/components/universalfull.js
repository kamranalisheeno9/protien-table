...
// Set Data 1 On Pagination
 ...
 const organismFive =()=>{
  ...
  return (
    ...
    <h6 >Full View</h6>
    <h6>Universal Tables of Organism Y</h6>
...
<Col >
      <ul>
        <li onClick={()=>organismOne()}>1</li>
        <li onClick={()=>organismTwo()}>2</li>
        <li onClick={()=>organismThree()} >3</li>
        <li onClick={()=>organismFour()} >4</li>
        <li onClick={()=>organismFive()} >5</li>
        </ul>
</Col>
